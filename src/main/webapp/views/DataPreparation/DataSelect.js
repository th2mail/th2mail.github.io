...
export default class DataSelect {
  ...
  initEvent() {
    ...
    $("#btnSave").click(function () {
      ...
      $.ajax({
        url: "http://localhost/prepare/group_create",
  ...
  selectGroupList() {    
    ...
    $.ajax({
      url: "http://localhost/prepare/group_list",
      data: JSON.stringify(param),
      method: "POST",
      contentType: "application/json; charset=utf-8",
      dataType: "json"
  ...
  selectCustomerList() {
    $.ajax({
      url: "http://localhost/prepare/orders",
      method: "POST",
      dataType: "json"
    })
    .done(function (json) {      
  ...
  selectGroupSensorList(groupId, _this) {
    ...
    $.ajax({
      type: "POST",
      url: "http://localhost/prepare/group_select",
      data: JSON.stringify(param),
      contentType: "application/json; charset=utf-8",
      dataType: "json"
    })
  ...
  selectSiteList(customerId, siteId, group_sensor_list, _this) {
    ...
    $.ajax({
      type: "POST",
      url: "http://localhost/prepare/sites",
      data: JSON.stringify(param),
      contentType: "application/json; charset=utf-8",
      dataType: "json"
    })
  ...
  selectSensorList(siteId, _this, group_sensor_list) {
    ...
    $.ajax({
      type: "POST",
      url: "http://localhost/prepare/sensors",
      data: JSON.stringify(param),
      contentType: "application/json; charset=utf-8",
      dataType: "json"
    })
